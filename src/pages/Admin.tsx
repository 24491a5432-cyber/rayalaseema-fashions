...
const Admin = () => {
  ...
  const { logout, adminId } = useAdminAuth();
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Welcome, {adminId}</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">Today: 3</span>
                  </div>
                </div>
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Checkout Reaches</p>
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">{section.description}</p>
                     <Button 
                      ...
                      onClick={() => {
                        ...
                        } else if (section.title === "Manage Orders") {
                          navigate("/admin/orders");
                        } else if (section.title === "Analytics") {
                          navigate("/admin/analytics");
                        } else if (section.title === "Customer Management") {
                          navigate("/admin/customers");
                        } else if (section.title === "Inventory Control") {
